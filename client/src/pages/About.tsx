...
import artistImage from "@assets/generated_images/artist_profile_portrait.png";
      ...
      <section className="py-20 md:py-32">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="prose prose-lg dark:prose-invert mx-auto">
            <p>
              Growing up in a small town, I was surrounded by makers. My grandmother 
              crocheted blankets for every new baby in our community, and watching her 
              work was like watching magic unfold. She taught me that handmade items 
              carry love in every fiber.
            </p>
            <p>
              After college, I found myself in a corporate job that left me feeling 
              unfulfilled. It was during a particularly stressful period that I picked 
